...
The normal-mode command to move to the end of the line is with the dolar symbol. You can copy to the start/end of the line with 0[dolar symbol] or y[dolar symbol] and paste with p. To copy/paste between different instances, you can use the system clipboard by selecting the * register, so the commands become "\*y[dolar symbol] for copying and "\*p for pasting.
